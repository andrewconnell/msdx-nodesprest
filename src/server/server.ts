...
let handlebarsDateFormat: any = require('handlebars-dateformat');
...
// configure handlebars with date format helper
expressHandlebars.registerHelper('dateFormat', handlebarsDateFormat);
